                ...
                <div class="mini-profile">
                    <label>
                        <div class="img-div" id="current_user_passport1">
                            <img src="<?php echo $website_url;?>/uploaded_files/user_pix/friends.png" id="passportimg3" alt="profile picture"/>                                
                        </div> 
                    ...
                    <div class="profile-segment-div col-6">
                        ...
                        <div class="text-field-div no-border">
                            ...
                            <option value="" >SELECT ROLE </option>
                                ...
                                <?php }else if($login_role_id==2){?>
                                    <script>_get_select_role('updt_role_id','1,2');</script>
                                <?php }else{?>
                                    <script>_get_select_role('updt_role_id','1');</script>
                                <?php }?>
                            </select>
                        </div>
                    </div> 
