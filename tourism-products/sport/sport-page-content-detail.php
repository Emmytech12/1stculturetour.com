...
<meta property="og:image" content="<?php echo $uploaded_file_url?>/sport_pix/seo_pix/<?php echo $page_seo_pix?>"/>
<meta property="og:description" content="<?php echo $page_seo_description?>"/>

<meta name="twitter:title" content="<?php echo $page_title?>"/> 
<meta name="twitter:card" content="<?php echo $thename?>"/> 
<meta name="twitter:image"  content="<?php echo $uploaded_file_url?>/sport_pix/seo_pix/<?php echo $page_seo_pix?>"/> 
            ...
            <div class="top-title-div">
                <div class="div-in">
					<ul>
						...
						<a href="<?php echo $website_url?>/tourism-products/sport" title="Sport"><li> Sport <i class="bi-caret-right-fill"></i></li></a>
						<a href="<?php echo $website_url?>/tourism-products/sport/"><li id="page_url"></li></a>
					</ul>
                </div>			
            </div>
		...
		<div class="body-div-in">
			<div class="gen-content-back-detail main-pg-top-div">
				<div class="left-div">
					<div class="main-back-img-div">
						...
						<div class="bottom-img-div">
							<div class="inner-img-container" id="fetch_pix_preview_div"> 
								<script> _fetch_tourism_products_other_pix('<?php echo $page_id?>','sport');</script>
							</div>
					...
					<br clear="all"/>
					<script> _get_each_sport_page('<?php echo $page_id?>');</script>
				</div>
					...
					<div class="inner-div">
						<h4>RELATED SPORT</h4>
							...
							<div class="fetch" id="fetch_related_pages">
								<script> _get_related_pages('all_sport');</script>
							</div>

						<a href="<?php echo $website_url ?>/tourism-products/sport/" title="Event">
