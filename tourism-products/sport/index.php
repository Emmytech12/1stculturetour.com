...
<title> Sport | <?php echo $thename?></title>
...
<div class="other-pages-title" data-aos="fade-down" data-aos-duration="1200">
	<div class="inner-div">
            ...
            <div class="top-title-div">
                <div class="div-in">
					<ul>
						...
						<a href="<?php echo $website_url?>/tourism-products/sport" title="Sport"><li id="tourism_products_url"> Sport</li></a>
					</ul>
                </div>			
            </div>
        ...
        <div class="image-back-div">
            <div class="left-img">
                <img src="<?php echo $website_url?>/all-images/body-pix/pics1.jpg" alt="about-us-image"/>
            </div>

            <div class="top-img">
                <img src="<?php echo $website_url?>/all-images/body-pix/pics2.jpg" alt="about-us-image"/>
            </div>

            <div class="bottom-img">
                <img src="<?php echo $website_url?>/all-images/body-pix/pics3.jpg" alt="about-us-image"/>
            </div>
        </div>	
    </div>
	<script> _get_each_tourist_products('each_sport');</script>
</div> 
	...
	<section class="body-div harsh-bg display-none">
		<div class="body-div-in">
            <div class="details-back-div"> 
				<div class="details-div" id="pane_sport"> 
			...
			<div class="gen-content-back-detail">
				<div class="left-div">
					<div class="content-back-div">
						<div class="fetch" id="fetch_all_sport">
							<script> _get_main_bottom_sport_page();</script>
						</div>
					</div>
				</div>
