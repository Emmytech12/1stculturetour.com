...
<title> Tourist Destinations | <?php echo $thename?></title>
...
<div class="other-pages-title" data-aos="fade-down" data-aos-duration="1200">
	<div class="inner-div">
            ...
            <div class="top-title-div">
                <div class="div-in">
					<ul>
						...
						<a href="<?php echo $website_url?>/tourist_destination" title="Culture"><li id="tourism_products_url"> Tourist Destinations </li></a>
					</ul>
                </div>			
            </div>
        ...
        <div class="image-back-div">
            <div class="left-img">
                <img src="<?php echo $website_url?>/all-images/body-pix/tourist-destiation1.jpg" alt="tourist destiation"/>
            </div>

            <div class="top-img">
                <img src="<?php echo $website_url?>/all-images/body-pix/tourist-destiation2.jpg" alt="tourist destiation"/>
            </div>

            <div class="bottom-img">
                <img src="<?php echo $website_url?>/all-images/body-pix/tourist-destiation3.jpg" alt="tourist destiation"/>
            </div>
        </div>	
    </div>
	<script> _get_each_tourist_products('each_tourist_destination');</script>
</div> 
	...
	<section class="body-div harsh-bg display-none">
		<div class="body-div-in">
            <div class="details-back-div"> 
				<div class="details-div" id="pane_tourist_destinations"> 
					<div class="gallery-back-div"> 
						...
						<div class="right-gallery-div">
                    		<div class="african-back-div pg-tourist-destination">
				...
				<div class="left-div">
					<div class="content-back-div">
						<div class="fetch" id="fetch_all_tourist_destination">
							<script> _get_bottom_tourist_destination_page();</script>                  
						</div>
					</div>
				</div>
