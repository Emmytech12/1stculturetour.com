...
<meta property="og:image" content="<?php echo $uploaded_file_url?>/natural_tourism_product_pix/seo_pix/<?php echo $page_seo_pix?>"/>
<meta property="og:description" content="<?php echo $page_seo_description?>"/>

<meta name="twitter:title" content="<?php echo $page_title?>"/> 
<meta name="twitter:card" content="<?php echo $thename?>"/> 
<meta name="twitter:image"  content="<?php echo $uploaded_file_url?>/natural_tourism_product_pix/seo_pix/<?php echo $page_seo_pix?>"/> 
	...
	<div class="inner-div">
            ...
            <div class="top-title-div">
                <div class="div-in">
					<ul>
						...
						<a href="<?php echo $website_url?>/tourism-products/natural-tourism-products" title="Natural Tourism Products"><li> Natural Tourism Products <i class="bi-caret-right-fill"></i></li></a>
						<a href="<?php echo $website_url?>/tourism-products/natural-tourism-products/"><li id="page_url"></li></a>
					</ul>
                </div>			
            </div>
		...
		<div class="image-back-div main-pg-info-pix">
            <div class="left-img main-pg-pix" id="view_page_pix2">
				<img src="" alt="natural-tourism-products"/>
            </div>
        </div>	
				...
				<div class="left-div">
					<div class="main-back-img-div">
						...
						<div class="main-img-div" id="preview-img" onclick="openFullScreen()">
							<div id="view_page_pix"><img src="<?php echo $website_url?>/uploaded_files/default_pix/default_pix.jpg" alt="Event"/></div>
						</div>

						<div class="bottom-img-div">
							<div class="inner-img-container" id="fetch_pix_preview_div"> 
								<script> _fetch_tourism_products_other_pix('<?php echo $page_id?>','natural_tourism_products');</script>
							</div>
					...
					<br clear="all"/>
					<script> _get_each_natural_tourism_products_page('<?php echo $page_id?>');</script>
				</div>
				
				<div class="right-div sticky-div">
					<div class="inner-div">
						<h4>RELATED NATURAL TOURISM PRODUCTS</h4>

							<div class="fetch" id="fetch_related_pages">
								<script> _get_related_pages('all_natural_tourism_products');</script>
							</div>

						<a href="<?php echo $website_url ?>/tourism-products/natural-tourism-products/" title="Event">
                        <button class="btn" title="Tourism Products">VIEW ALL NATURAL TOURISM PRODUCTS </button></a>
					</div>
				</div>
				<br clear="all"/>
			</div>
