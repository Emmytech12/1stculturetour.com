...
<title> Entertainment | <?php echo $thename?></title>
...
<div class="other-pages-title" data-aos="fade-down" data-aos-duration="1200">
	<div class="inner-div">
            ...
            <div class="top-title-div">
                <div class="div-in">
					<ul>
						...
						<a href="<?php echo $website_url?>/tourism-products/entertainment" title="Entertainment"><li id="tourism_products_url"> Entertainment</li></a>
					</ul>
                </div>			
            </div>
        ...
        <div class="image-back-div" data-aos="fade-in" data-aos-duration="1200">
            <div class="left-img entertainment-left-img">
                <img src="<?php echo $website_url?>/all-images/body-pix/entertainment1.jpg" alt="entertainment"/>
            </div>

            <div class="top-img entertainment-top-img">
                <img src="<?php echo $website_url?>/all-images/body-pix/entertainment2.png" alt="entertainment"/>
            </div>
        </div>
    </div>
	<script> _get_each_tourist_products('each_entertainment');</script>
</div> 
	...
	<section class="body-div harsh-bg display-none">
		<div class="body-div-in">
            <div class="details-back-div"> 
				<div class="details-div" id="pane_entertainment"> 
                    <div class="ent-content-div">
                        ...
                        <div class="bottom-back-div">
							...
							<!-- <a href="<?php //echo $website_url ?>/#" title="Emotional Moment Veteran Actor Baba Amoye Cried">
                            <div class="bottom-div">
                                <div class="entertainment">Entertainment</div>
                                <div class="img-div">
                                    <img src="<?php //echo $website_url?>/all-images/body-pix/bae.jpg" alt="ibudo" />
                                </div>

                                <div class="text-div">
                                    <div class="div-in">
                                        <span class="time"><i class="bi-clock"></i> November 28, 2023</span>
                                        <h2>Emotional Moment Veteran Actor Baba Amoye Cried....</h2>
                                    </div>
                                </div>
                            </div></a> -->
                        </div>
			...
			<div class="gen-content-back-detail">
				<div class="left-div">
					<div class="content-back-div">
						<div class="fetch" id="fetch_all_entertainment">
							<script> _get_main_bottom_entertainment_page();</script>
						</div>
					</div>
				</div>
