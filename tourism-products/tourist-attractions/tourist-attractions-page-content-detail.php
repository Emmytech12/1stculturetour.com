...
<meta property="og:image" content="<?php echo $uploaded_file_url?>/tourist_attraction_pix/seo_pix/<?php echo $page_seo_pix?>"/>
<meta property="og:description" content="<?php echo $page_seo_description?>"/>

<meta name="twitter:title" content="<?php echo $page_title?>"/> 
<meta name="twitter:card" content="<?php echo $thename?>"/> 
<meta name="twitter:image"  content="<?php echo $uploaded_file_url?>/tourist_attraction_pix/seo_pix/<?php echo $page_seo_pix?>"/> 
            ...
            <div class="top-title-div">
                <div class="div-in">
					<ul>
						...
						<a href="<?php echo $website_url?>/tourism-products/tourist-attractions" title="Tourist Attractions"><li> Tourist Attractions <i class="bi-caret-right-fill"></i></li></a>
						<a href="<?php echo $website_url?>/tourism-products/tourist-attractions/"><li id="page_url"></li></a>
					</ul>
                </div>			
            </div>

			<h1 class="border"><span id="page_title"></span></h1>	
			<div class="count"><i class="bi-person"></i> By: <span id="fullname">xxxx</span> | <i class="bi-calendar3"></i> DATE: <span id="formattedDate">xxxx</span> | <i class="bi-eye"></i> VIEWS: <span id="page_views">xxxx</spani></div>
			<p id="page_summary"></p>
        </div>

		<div class="image-back-div main-pg-info-pix">
            <div class="left-img main-pg-pix" id="view_page_pix2">
				<img src="" alt="Tourist-Attractions"/>
            </div>
        </div>	
				...
				<div class="left-div">
					<div class="main-back-img-div">
						...
						<div class="main-img-div" id="preview-img" onclick="openFullScreen()">
							<div id="view_page_pix"><img src="<?php echo $website_url?>/uploaded_files/default_pix/default_pix.jpg" alt="Tourist-Attractions"/></div>
						</div>

						<div class="bottom-img-div">
							<div class="inner-img-container" id="fetch_pix_preview_div"> 
								<script> _fetch_tourism_products_other_pix('<?php echo $page_id?>','tourist_attraction');</script>
							</div>
					...
					<div class="main-content-div">
						<div class="content-txt" id="page_detail"></div>
					...
					<br clear="all"/>
					<script> _get_each_tourist_attraction_page('<?php echo $page_id?>');</script>
				</div>
				
				<div class="right-div sticky-div">
					<div class="inner-div">
						<h4>RELATED TOURIST ATTRACTIONS</h4>

							<div class="fetch" id="fetch_related_pages">
								<script> _get_related_pages('all_tourism_attraction');</script>
							</div>

						<a href="<?php echo $website_url ?>/tourism-products/tourist-attractions/" title="Tourist Attractions">
                        <button class="btn" title="Tourism Products">VIEW ALL TOURIST ATTRACTIONS </button></a>
					</div>
				</div>
				<br clear="all"/>
			</div>
