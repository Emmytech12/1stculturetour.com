...
<?php 
if ($mail_to_send=='send_reset_password_link'){
...
Kindly, click on this reset password link <span><a style="color:#F00" href="'.$website_url.'/admin/login/reset-password/?hvid='.$hash_id.'">'.$website_url.'/admin/login/reset-password/?hvid='.$hash_id.'</a></span> to complete your reset password process.
</p>
<p>
